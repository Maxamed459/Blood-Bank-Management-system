...
const RegisterPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center p-5 relative bg-[url(/bg.jpg)] bg-no-repeat bg-cover min-h-screen px-4 md:px-10 lg:px-20">
      ...
      <div className="w-full p-6 md:w-1/2 bg-white border-1 rounded-md border-gray-100/10 shadow-md">
        <div className="mb-8">
          <h1 className="text-xl font-medium text-black">Create an account</h1>
