  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full md:w-[85%] mx-auto flex flex-col lg:flex-row mt-15 gap-6">
        <div className="w-full lg:w-1/2 border shadow-md p-4 rounded-md">
          {user?.gender === "MALE" && <User className="w-24 h-24" />}
          {user?.gender === "FEMALE" && <SlUserFemale className="w-24 h-24" />}

          <div className="mt-4">
            <div className="mt-4">
              <p className="border-b py-1 text-muted-foreground">
                <b>Fullname: </b>
                {user?.fullname}
              </p>
              <p className="border-b py-1 text-muted-foreground">
        ...
        <div className="w-full lg:w-1/2 grid gap-4">
          <div className="border shadow-md p-4 rounded-md border-t-4 border-t-blue-600">
          ...
          <div className="border shadow-md p-4 rounded-md border-t-4 border-t-[#E81C24]">
